...
| Spectral defect controls `2 * sum_{i<j} |G_ij|^2` | **Lean proved on review branch** | `ZetaSeven.BlockDefect`; rebuild and axiom audit required before merge. |
...
| Candidate `67.3025476837...%` bound | **Open end-to-end** | Requires the verified interval replay, block pinching/window formalization, and complete analytic integration retaining the defect. |
