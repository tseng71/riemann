...
$o(N)$.  It does not yet replay the Arb certificate or close the
local-to-global seven-point bridge and its concrete top-level specialization.
...
layers and an abstract defect-preserving Theorem~D source inequality.  It
leaves the local certificate replay, the local-to-global defect comparison,
and concrete top-level specialization as explicit open obligations.  Subject to those stated
...
lemmas, the defect-preserving abstract Theorem~D source inequality, and exact
assembly, but does not yet prove the local seven-point claim or the
strengthened end-to-end top-level statement.
...
off-diagonal Gram energy to spectral defect, the abstract
