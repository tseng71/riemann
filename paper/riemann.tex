...
Lean objects, with positivity and telescoping spans checked.  It does not yet replay the
...
concrete consecutive 267-point principal block.  It leaves the local certificate replay,
