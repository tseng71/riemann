...
conditional 267-point block bridge.  It does not yet replay the Arb
certificate or close the concrete central-zero partition, endpoint,
...
defect-preserving Theorem~D source inequality.  It leaves the local
certificate replay, concrete ordered-zero partition and endpoint wiring,
